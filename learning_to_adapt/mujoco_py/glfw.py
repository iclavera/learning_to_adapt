...
def _load_library():
    ...
    if sys.platform.startswith("darwin"):
        libfile = osp.join(osp.expanduser('~'), '.mujoco/mjpro131/bin/libglfw.3.dylib')
    elif sys.platform.startswith("linux"):
        libfile = osp.join(osp.expanduser('~'), '.mujoco/mjpro131/bin/libglfw.so.3')
    elif sys.platform.startswith("win"):
        libfile = osp.join(osp.expanduser('~'), '.mujoco/mjpro131/bin/glfw3.dll')
    else:
